...
class TestMB01SDRowScaling:
    """Test row scaling: A := diag(R) * A"""

    def test_row_scaling_basic(self):
        """
    ...
    def test_row_scaling_identity(self):
...
class TestMB01SDColumnScaling:
    """Test column scaling: A := A * diag(C)"""

    def test_column_scaling_basic(self):
        """
    ...
    def test_column_scaling_identity(self):
...
class TestMB01SDBothScaling:
    """Test both row and column scaling: A := diag(R) * A * diag(C)"""

    def test_both_scaling_basic(self):
        """
    ...
    def test_both_scaling_square(self):
        """
...
class TestMB01SDEdgeCases:
    ...
    def test_scaling_commutativity(self):
        """
...
class TestMB01SDNumericalAccuracy:
    """Test numerical accuracy with specific values."""

    def test_exact_values_row_scaling(self):
    ...
    def test_exact_values_column_scaling(self):
    ...
    def test_exact_values_both_scaling(self):
