...
class TestTC01ODBasic:
    """Basic functionality tests using HTML doc example."""

    def test_left_to_right_dual_2x2(self):
        """
...
class TestTC01ODTranspositionProperty:
    ...
    def test_right_representation_transpose(self):
        """
...
class TestTC01ODEdgeCases:
    ...
    def test_scalar_system_m1_p1(self):
        """
    ...
    def test_rectangular_m_greater_than_p(self):
        """
    ...
    def test_rectangular_p_greater_than_m(self):
        """
...
class TestTC01ODErrorHandling:
    ...
    def test_zero_m_quick_return(self):
    ...
    def test_zero_p_quick_return(self):
