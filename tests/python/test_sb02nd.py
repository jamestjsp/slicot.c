...
class TestSB02NDBasic:
    """Basic functionality tests from HTML documentation."""

    def test_discrete_time_html_example(self):
        """
    ...
    def test_continuous_time_basic(self):
        """
...
class TestSB02NDMathematicalProperties:
    """Mathematical property validation tests."""

    def test_discrete_feedback_formula(self):
        """
    ...
    def test_continuous_feedback_formula(self):
        """
    ...
    def test_zero_cross_term_l(self):
        """
...
class TestSB02NDEdgeCases:
    ...
    def test_lower_triangular_uplo_l(self):
        """
...
class TestSB02NDFactoredR:
    """Tests for pre-factored R matrix (FACT='C', 'D')."""

    def test_cholesky_factored_r_continuous(self):
        """
...
class TestSB02NDErrorHandling:
    ...
    def test_singular_coefficient_matrix(self):
        """
