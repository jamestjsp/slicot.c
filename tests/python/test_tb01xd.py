...
class TestTB01XDBasic:
    """Basic functionality tests."""

    def test_small_system_full_matrix(self):
        """
...
class TestTB01XDMathematicalProperties:
    ...
    def test_pertransposition_on_symmetric_matrix(self):
        """
