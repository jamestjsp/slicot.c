...
class TestMB05NDEdgeCases:
    ...
    def test_n_equals_one_zero_matrix(self):
        """
...
class TestMB05NDMathematicalProperties:
    """Mathematical property tests for numerical correctness."""

    def test_exp_integral_relationship(self):
        """
...
class TestMB05NDErrorHandling:
    ...
    def test_large_delta_overflow(self):
        """
