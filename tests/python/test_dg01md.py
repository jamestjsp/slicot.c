...
class TestDG01MDBasic:
    """Basic functionality tests from SLICOT HTML documentation."""

    def test_forward_fft_doc_example(self):
        """
...
class TestDG01MDInverseProperty:
    """Test inverse transform property: FFT then IFFT scales by N."""

    def test_forward_inverse_scaling(self):
        """
    ...
    def test_inverse_forward_scaling(self):
        """
...
class TestDG01MDMathematicalProperties:
    ...
    def test_real_signal_conjugate_symmetry(self):
        """
...
class TestDG01MDErrors:
    """Error handling tests."""

    def test_invalid_indi(self):
